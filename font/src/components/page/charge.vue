        ...
        <div class="container">
            <el-row :gutter="22">
                <el-col :span="12">
                    ...
                    <el-input class="inputSty" placeholder="请输入名字" v-model="name" :input="refresh">
                    ...
                    <el-upload class="upload-demo" drag :action="upload">
...
export default {
    ...
    methods: {
        refresh() {
            this.upload = CONST.url + '/question6/upload/' + this.name + '/' + this.testmethod;
            this.download = CONST.url + '/question6/download/' + this.name + '/' + this.testmethod;
        ...
        getAcc() {
            var that = this;
            var temp;
            axios.get(CONST.url + '/question6/getAccuracy/' + this.name + '/' + this.testmethod).then(function (response) {
